 ...
 */
class SyntheticClassOrObjectDescriptorBackport(
    c: LazyClassContext,
    ...
    private val thisDescriptor: SyntheticClassOrObjectDescriptorBackport get() = this // code readability
...
fun KtPureElement.findClassDescriptor(bindingContext: BindingContext): ClassDescriptor = when (this) {
    ...
    is SyntheticClassOrObjectDescriptorBackport.SyntheticDeclaration -> descriptor()
    else -> throw IllegalArgumentException("$this shall be PsiElement or SyntheticClassOrObjectDescriptorBackport.SyntheticDeclaration")
}
