...
import org.jetbrains.kotlinx.serialization.compiler.extensions.SyntheticClassOrObjectDescriptorBackport
import java.util.*
...
object KSerializerDescriptorResolver {
    ...
    fun addSerialInfoImplClass(interfaceDesc: ClassDescriptor, declarationProvider: ClassMemberDeclarationProvider, ctx: LazyClassContext): ClassDescriptor {
        ...
        val descriptor = SyntheticClassOrObjectDescriptorBackport(
            ctx,
            interfaceDecl,
            interfaceDesc,
            IMPL_NAME,
    ...
    fun addSerializerImplClass(
        ...
        val serializerDescriptor = SyntheticClassOrObjectDescriptorBackport(
            ctx,
            thisDeclaration,
